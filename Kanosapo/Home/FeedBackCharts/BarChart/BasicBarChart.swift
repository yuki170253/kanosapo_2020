...
class BasicBarChart: UIView {
    ...
    let dayresultdetail = DayResultDetailViewController()
    ...
    func moveCordinate1(x1:Int, y1:Int) {
        let point:CGPoint = CGPoint(x: x1, y: y1)
    ...
    private func showEntry(index: Int, barEntry: BasicBarEntry, animated: Bool, oldEntry: BasicBarEntry?) {
